...
const Download = () => {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900 via-blue-900 to-indigo-900 text-white">
  ...
  <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
    ...
    <div className="space-y-4">
      ...
      <div className="text-center">
        <a href="https://yourwebsite.com" target="_blank" rel="noopener noreferrer">
          <div className="w-32 h-32 bg-white rounded-2xl mx-auto mb-4 flex items-center justify-center shadow-lg hover:scale-105 transition-transform">
    ...
    <div className="mt-8 text-center">
      <a
        href="https://github.com/yourusername/buzzapp-codebase"
        target="_blank"
