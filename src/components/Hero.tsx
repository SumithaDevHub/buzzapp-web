...
const Hero = () => {
  return (
    <section className="relative h-[45vh] flex items-center justify-center px-4 sm:px-6 lg:px-20 overflow-hidden bg-gradient-to-b from-purple-200 via-purple-100 to-white">
